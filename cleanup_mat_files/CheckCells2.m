function PH_paths = CheckCells2(mat_path, PH_paths, division, timelapse)
% CHECKCELLS2: check the cells identified by Oufti and delete entries in the
...
if (division && timelapse) || ~timelapse
